 ...
 * @return array
 */
function graphPraticienDisciplineForMonth(
  $date = null, $prat_id = 0, $salle_id = 0, $bloc_id = 0,
  $func_id = 0, $discipline_id = 0, $codeCCAM = "", $type_hospi = "", $hors_plage = true
) {
  if (!$date) {
    $date = CMbDT::date("first day of last month");
  }
  ...
  $title    = "Nombre d'intervention par praticien en " . CMbDT::transform(null, $debut, '%B %Y');
