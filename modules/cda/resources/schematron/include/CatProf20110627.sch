...
<!-- 
    catProf.sch :
    Contenu :
    Contrôle du code de la catégorie professionnelle d'une personne de la section Coded Social history  (nullFlavor interdit)
...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="catProf" is-a="dansJeuDeValeurs">
