...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="CS9ModeleEnTete">
    ...
    <rule context="cda:ClinicalDocument">
        ...
        <assert test="cda:templateId[@root='1.3.6.1.4.1.19376.1.7.3.1.1.13.2']"> 
            Erreur: Le template parent "QRPH Child Growth Summary" (1.3.6.1.4.1.19376.1.7.3.1.1.13.2) doit être présent.
        </assert>
