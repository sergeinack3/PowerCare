...
<xsl:stylesheet version="1.0"
    ...
    <xsl:import href="modules/cda/resources/xsl/headers.xsl"/>
    <xsl:import href="modules/cda/resources/xsl/style.xsl"/>
    ...
    <xsl:template match="n1:ClinicalDocument">
        <html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="modules/cda/resources/xsl/cda.css"/>
            </head>
            <body>
                <h1 class="h1center">
                    <xsl:value-of select="$title"/>
