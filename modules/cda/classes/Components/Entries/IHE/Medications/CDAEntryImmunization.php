...
/**
 * Class CDAEntryImmunization
 * @package Ox\Interop\Cda\Components\Entries\IHE\Medications
 */
class CDAEntryImmunization extends CDAEntryAct
{
    /** @var string */
    public const TEMPLATE_ID = '1.3.6.1.4.1.19376.1.5.3.1.4.12';
