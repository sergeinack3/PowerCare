...
use Ox\Interop\Cda\Datatypes\Voc\CCDAx_DocumentEncounterMood;
use Ox\Interop\Cda\Rim\CCDARIMAct;

/**
 * POCD_MT000040_Encounter Class
 */
class CCDAPOCD_MT000040_Encounter extends CCDARIMAct {
  ...
  function setMoodCode($inst) {
    ...
    $act = new CCDAx_DocumentEncounterMood();
    $act->setData($inst);
    $this->moodCode = $act;
  }
   ...
   * Getter moodCode
   *
   * @return CCDAx_DocumentEncounterMood
   */
  ...
  function getProps() {
    ...
    $props["moodCode"]          = "CCDAx_DocumentEncounterMood xml|attribute required";
    return $props;
  }
