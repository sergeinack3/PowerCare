...
use Ox\Interop\Cda\Datatypes\Voc\CCDAx_DocumentProcedureMood;
use Ox\Interop\Cda\Rim\CCDARIMProcedure;

/**
 * POCD_MT000040_Procedure Class
 */
class CCDAPOCD_MT000040_Procedure extends CCDARIMProcedure {
  ...
  function setMoodCode($inst) {
    ...
    $doc = new CCDAx_DocumentProcedureMood();
    $doc->setData($inst);
    $this->moodCode = $doc;
  }
   ...
   * Getter moodCode
   *
   * @return CCDAx_DocumentProcedureMood
   */
  ...
  function getProps() {
    ...
    $props["classCode"]         = "CCDAActClass xml|attribute required";
    $props["moodCode"]          = "CCDAx_DocumentProcedureMood xml|attribute required";
