...
/**
 * POCD_MT000040_AssignedAuthor Class
 */
class CCDAPOCD_MT000040_AssignedAuthor extends CCDARIMRole {
  ...
  /**
   * @var CCDAPOCD_MT000040_AuthoringDevice
   */
  ...
  /**
   * Setter assignedAuthoringDevice
   *
   * @param CCDAPOCD_MT000040_AuthoringDevice $inst CCDAPOCD_MT000040_AuthoringDevice
   *
   * @return void
   */
  function setAssignedAuthoringDevice(CCDAPOCD_MT000040_AuthoringDevice $inst) {
    $this->assignedAuthoringDevice = $inst;
  }

  /**
   * Getter assignedAuthoringDevice
   *
   * @return CCDAPOCD_MT000040_AuthoringDevice
   */
  function getAssignedAuthoringDevice() {
  ...
  function getProps() {
    ...
    $props["assignedAuthoringDevice"] = "CCDAPOCD_MT000040_AuthoringDevice xml|element max|1";
