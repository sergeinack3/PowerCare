...
use Ox\Interop\Cda\Rim\CCDARIMManufacturedMaterial;

/**
 * POCD_MT000040_Material Class
 */
class CCDAPOCD_MT000040_Material extends CCDARIMManufacturedMaterial {
  ...
  /**
   * Setter lotNumberText
   *
   * @param CCDAST $inst CCDAST
   *
   * @return void
   */
  function setLotNumberText(CCDAST $inst) {
    $this->lotNumberText = $inst;
  }

  /**
   * Getter lotNumberText
   *
   * @return CCDAST
   */
  function getLotNumberText() {
  ...
  function getProps() {
    ...
    $props["lotNumberText"]  = "CCDAST xml|element max|1";
