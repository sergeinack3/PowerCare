...
use Ox\Interop\Cda\Datatypes\Voc\CCDAx_ActMoodDocumentObservation;
use Ox\Interop\Cda\Rim\CCDARIMObservation;

/**
 * POCD_MT000040_Observation Class
 */
class CCDAPOCD_MT000040_Observation extends CCDARIMObservation {
  ...
  /**
   * @var CCDAPOCD_MT000040_ReferenceRange[]
   */
  ...
  /**
   * Setter derivationExpr
   *
   * @param CCDAST $inst CCDAST
   *
   * @return void
   */
  function setDerivationExpr(CCDAST $inst) {
    $this->derivationExpr = $inst;
  }

  /**
   * Getter derivationExpr
   *
   * @return CCDAST
   */
  function getDerivationExpr() {
   ...
   * @return void
   */
  function appendValue(CCDAANY $inst) {
   ...
   * @return void
   */
  function appendInterpretationCode(CCDACE $inst) {
    array_push($this->interpretationCode, $inst);
  }
   ...
   * @return void
   */
  function resetListInterpretationCode() {
   ...
   * @return void
   */
  function appendMethodCode(CCDACE $inst) {
    array_push($this->methodCode, $inst);
  }
   ...
   * @return void
   */
  function appendTargetSiteCode(CCDACD $inst) {
    array_push($this->targetSiteCode, $inst);
  }
   ...
   * @return void
   */
  function resetListTargetSiteCode() {
    $this->targetSiteCode = array();
  }

  /**
   * Getter targetSiteCode
   *
   * @return CCDACD[]
   */
  function getTargetSiteCode() {
   ...
   * Ajoute l'instance spécifié dans le tableau
   *
   * @param CCDAPOCD_MT000040_ReferenceRange $inst CCDAPOCD_MT000040_ReferenceRange
   *
   * @return void
   */
  function appendReferenceRange(CCDAPOCD_MT000040_ReferenceRange $inst) {
    array_push($this->referenceRange, $inst);
  }
   ...
   * @return void
   */
  function resetListReferenceRange() {
    $this->referenceRange = array();
  }

  /**
   * Getter referenceRange
   *
   * @return CCDAPOCD_MT000040_ReferenceRange[]
   */
  ...
  function setMoodCode($inst) {
    ...
    $ob = new CCDAx_ActMoodDocumentObservation();
    $ob->setData($inst);
    $this->moodCode = $ob;
  }
   ...
   * Getter moodCode
   *
   * @return CCDAx_ActMoodDocumentObservation
   */
