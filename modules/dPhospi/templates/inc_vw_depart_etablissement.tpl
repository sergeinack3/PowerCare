...
<script>
  Main.add(function() {
    var form = getForm('departEtablissement');
...
<form name="departEtablissement" method="post"
  ...
  <table class="form">
    <tr>
      <th class="title" colspan="2">
        {{tr var1=$affectation->_ref_sejour->_ref_patient->_view}}CSejour-Choose bed in etablissement{{/tr}}
      </th>
    </tr>
    <tr>
      <th class="halfPane">
