...
<button id="send-all-presta-button" type="button" class="prestation me-primary" onclick="Prestation.sendAllPresta('{{$type}}');">
  {{tr}}CPrestationJournaliere-send_for_select{{/tr}}
</button>
