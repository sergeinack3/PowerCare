...
$_POST["ajax"] = 1;
$doPatient->doSingle(false);

if ($doPatient->_obj->_id && $doPatient->_obj->code_cim10) {
    CAppUI::callbackAjax("Snomed.checkCodeExist", $doPatient->_obj->code_cim10, $doPatient->_obj->_guid);
}

$doPatient->doRedirect();
