 ...
 * Description
 */
class CConfigurationAltStrategy implements IConfigurationStrategy, IShortNameAutoloadable
{
    /**
     * @inheritDoc
     */
    public function getStoredConfigurations($module, CMbObjectSpec $spec, bool $static = false)
    {
        ...
        $select = [
            ...
            'COALESCE(`alt_value`, `value`) AS `value`',
            'object_class',
            'object_id',
        ...
        $where = [
            ...
            'value'   => 'IS NOT NULL OR `alt_value` IS NOT NULL',
        ];
    ...
    {
        return $configuration->fieldModified('alt_value', $value) || $configuration->fieldModified('value', $value);
    }
}
