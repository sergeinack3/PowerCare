...
class ExClassConstraintOrOperatorTest extends OxUnitTestCase
{
    ...
    public function getConstraints(): array
    {
        ...
        return [
            ...
            'true || false'  => [$object, true, [$this->mockConstraint(true), $this->mockConstraint(false)]],
            'false || true'  => [$object, true, [$this->mockConstraint(false), $this->mockConstraint(true)]],
    ...
    public function testCheckConstraints(CMbObject $object, $expected, array $constraints): void
    {
        ...
        $operator = new ExClassConstraintOrOperator();
