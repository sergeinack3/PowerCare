...
/**
 * The C-Echo-RSP message
 * 
 * @see DICOM Standard PS 11_07, section 9.1.5 ans 9.3.5.2
 */
class CDicomMessageCEchoRSP implements IShortNameAutoloadable {
  ...
  /**
   * Identify the DIMSE-C operation, here C-Echo-RSP
   * 
   * @var CDicomDataSet
   */
