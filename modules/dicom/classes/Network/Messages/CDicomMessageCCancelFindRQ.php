...
/**
 * The C-Cancel-Find-RQ message
 * 
 * @see DICOM Standard PS 3.07, section 9.1.2 ans 9.3.2.3
 */
class CDicomMessageCCancelFindRQ implements IShortNameAutoloadable {
  ...
  function setCommandField() {
    $this->command_field = new CDicomDataSet(array("group_number" => 0x0000, "element_number" => 0x0100, "value" => 0x0fff));
  }
