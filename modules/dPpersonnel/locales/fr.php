...
$locales['CPersonnel-msg-This person does not have the rights to be created in this establishment multiple'] = 'Cette personne (%s) n\'a pas les droits pour être créée dans cet établissement';
$locales['CPersonnel-msg-Choose a type or types you wish to assign to users selected'] = "Choisisser un ou plusieurs types que vous souhaiter assigner aux utilisateurs sélectionnés";
...
$locales['CPersonnel-failed-personnel'] = "Un membre du personnel existe déjà pour cet utilisateur avec ce type rôle";
...
$locales['config-personnel-CPlageConge-show_replacer'] = 'Remplaçant global';
$locales['config-personnel-CPlageConge-show_replacer-desc'] = 'Gérer le remplaçant globalement au niveau de la plage de congés';
