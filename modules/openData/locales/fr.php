...
$locales['CCommuneDemographie-age_max-desc'] = 'Age maximum de la tranche d\'âge';
$locales['CCommuneDemographie-age_min'] = 'Age minimum';
$locales['CCommuneDemographie-age_min-court'] = 'Age min';
$locales['CCommuneDemographie-age_min-desc'] = 'Age minimum de la tranche d\'âge';
...
$locales['CCommuneDemographie-population-desc'] = 'Population pour la tranche d\'âge, sexe et nationalité de la commune';
...
$locales['CCommuneDemographie.nationalite.'] = 'Nationalité';
$locales['CCommuneDemographie.nationalite.etranger'] = 'Étrangé';
$locales['CCommuneDemographie.nationalite.francais'] = 'Français';
...
$locales['CCommuneFrance'] = 'Commune française';
...
$locales['CCommuneFrance-msg-found'] = 'Commune française retrouvée';
...
$locales['CHDActivite-hd_etablissement_id'] = 'Établissement';
$locales['CHDActivite-hd_etablissement_id-court'] = 'Établissement';
$locales['CHDActivite-hd_etablissement_id-desc'] = 'Établissement HospiDiag de l\'activité';
$locales['CHDActivite-indice_enseignement'] = 'Enseignement';
$locales['CHDActivite-indice_enseignement-court'] = 'Enseignement';
$locales['CHDActivite-indice_enseignement-desc'] = 'Cet indicateur permet d\'estimer la performance de l\'activité d\'enseignement de l\'établissement via l\'encadrement des étudiants formés (rapporté aux ETP dédiées à l\'enseignement)';
...
- des points SIGAPS (Système d \'Interrogation, de Gestion et d \'Analyse des Publications Scientifiques) pour les publications, 
- des points SIGREC (Système d‘Information et de Gestion de la Recherche et des Essais Cliniques) pour la recherche clinique 
...
$locales['CHDActivite-pct_entree_prov_urgence-desc'] = 'Cet indicateur mesure la contribution des urgences à l\'activ ité traditionnelle et permet d\'appréhender les impacts organisationnels des urgences sur les activités programmées des établissements. 
Il permet a contrario de mettre en évidence l\'attractivité intrinsèque de l\'établissement';
$locales['CHDActivite-pct_ghm'] = 'Pourcentage des GHM « recours / référence» dans l\'activité';
$locales['CHDActivite-pct_ghm-court'] = 'Pct GHM activité';
$locales['CHDActivite-pct_ghm-desc'] = 'Cet indicateur mesure le pourcentage de l\'activité réalisée sur des GHM pris en charge principalement mais non exclusivement dans les établissements hospitalo-universitaires. Il mesure une « technicité »de la prise en charge.
Ces activités ont été identifiées à partir du rapport ATIH« l\'activité des CHU dans le PMSI : peut-on isoler l\'activité spécifique des CHU ? » (Version 2, Mai 2009) croisées avec une DMS&gt; 3 j';
...
Pour chaque GHM, 4 niveaux de sévérité existent, définis par la V11, le niveau 1 étant le niveau de base, sans sévérité. Le niveau de sévérité est déterminé à partir des co-morbidités associées (ex : diabète, anorexie...), des durées minimum de séjours et de l\'âge';
...
$locales['CHDActivite-pm_chir_ambu_reg-desc'] = 'Cet indicateur mesure la part de marché de l\'établissement en chirurgie ambulatoire sur les patients de sa région et traduit ainsi la capacité de l\'établissement à avoir un rayonnement régional (positionnement sur des activités recours / référence)';
...
$locales['CHDActivite-pm_chir_reg-desc'] = 'Cet indicateur mesure la part de marché de l\'établissement en chirurgie complète sur les patients de sa région et traduit ainsi la capacité de l\'établissement à avoir un rayonnement régional';
...
$locales['CHDActivite-pm_med_reg-desc'] = 'Cet indicateur mesure la part de marché de l\'établissement en médecine sur les patients de sa région et traduit ainsi la capacité de l\'établissement à avoir un rayonnement régional';
...
$locales['CHDActivite-pm_obs_reg-desc'] = 'Cet indicateur mesure la part de marché de l\'établissement en obstétrique sur les patients de sa région et traduit ainsi la capacité de l\'établissement à avoir un rayonnement régional (positionnement sur des activités recours / référence)';
...
$locales['CHDActivite-taux_util_lits_chir-desc'] = 'Cet indicateur mesure l\'occupation, par des patients de chirurgie, des lits exploitables en chirurgie, en hospitalisation complète ou de semaine';
...
$locales['CHDActivite-taux_util_lits_med-desc'] = 'Cet indicateur mesure l\'occupation, par des patients de médecine, des lits exploitables en médecine, en hospitalisation complète ou de semaine';
...
$locales['CHDActivite-taux_util_lits_obs-desc'] = 'Cet indicateur mesure l\'occupation, par des patientes d\'obstétrique, des lits exploitables en obstétrique, en hospitalisation complète ou de semaine';
...
$locales['CHDActiviteZone-hd_etablissement_id'] = 'Établissement';
$locales['CHDActiviteZone-hd_etablissement_id-court'] = 'Établissement';
$locales['CHDActiviteZone-hd_etablissement_id-desc'] = 'Établissement de la zone d\'attractivité';
...
$locales['CHDActiviteZone-pm_chir-desc'] = 'Cet indicateur permet d\'appréhender la capacité de l\'établissement à s\'imposer sur sa zone d\'attractivité en chirurgie complète et de mettre en évidence ses concurrents. La définition de la zone d\'attractivité retenue est la suivante : la zone d\'attractivité d\'un établissement est le territoire défini par la liste des codes postaux dans lesquels l\'établissement réalise les taux d\'hospitalisation (Nb séjours de chirurgie complète/ Nb habitants) les plus élevés. Ces codes postaux sont classés de manière décroissante. Sont retenues dans la zone d\'attractivité de chirurgie les localités dont le cumul des séjours représente 80% de l\'activité de l\'établissement';
...
$locales['CHDActiviteZone-pm_chir_ambu-desc'] = 'Cet indicateur permet d\'appréhender la capacité de l\'établissement à s\'imposer sur sa zone d\'attractivité en chirurgie ambulatoire et de mettre en évidence ses concurrents. La définition de la zone d\'attractivité retenue est la suivante : la zone d\'attractivité d\'un établissement est le territoire défini par la liste des codes postaux dans lesquels l\'établissement réalise les taux d\'hospitalisation (Nb séjours de chirurgie ambulatoire/ Nb habitants) les plus élevés. Ces codes postaux sont classés de manière décroissante. Sont retenues dans la zone d\'attractivité de chirurgie les localités dont le cumul des séjours représente 80% de l\'activité de l\'établissement';
...
$locales['CHDActiviteZone-pm_hospi_cancer-desc'] = 'Cet indicateur permet d\'appréhender la capacité de l\'établissement à s\'imposer sur sa zone d\'attractivité en hospitalisation hors séances en cancérologie et de mettre en évidence ses concurrents. La définition de la zone d\'attractivité retenue est la suivante : la zone d\'attractivité d\'un établissement est le territoire défini par la liste des codes postaux dans lesquels l\'établissement réalise les taux d\'hospitalisation (Nb séjours hors séances / Nb habitants) les plus élevés. Ces codes postaux sont classés de manière décroissante. Sont retenues dans la zone d\'attractivité de chirurgie les localités dont le cumul des séjours représente 80% de l\'activité de l\'établissement';
...
$locales['CHDActiviteZone-pm_med-desc'] = 'Cet indicateur permet d\'appréhender la capacité de l\'établissement à s\'imposer sur sa zone d\'attractivité en médecine et de mettre en évidence ses concurrents. La définition de la zone d\'attractivité retenue est la suivante : la zone d\'attractivité d\'un établissement est le territoire défini par la liste des codes postaux dans lesquels l\'établissement réalise les taux d\'hospitalisation (Nb séjours médicaux/ Nb habitants) les plus élevés. Ces codes postaux  ont classés de manière décroissante. Sont retenues dans la zone d\'attractivité de médecine, les localités dont le cumul des séjours représente 80% de l\'activité de l\'établissement';
...
$locales['CHDActiviteZone-pm_obs-desc'] = 'Cet indicateur permet d\'appréhender la capacité de l\'établissement à s\'imposer sur sa zone d\'attractivité en obstétrique et de mettre en évidence ses concurrents. La définition de la zone d\'attractivité retenue est la suivante : la zone d\'attractivité d\'un établissement est le territoire défini par la liste des codes postaux dans lesquels l\'établissement réalise les taux d\'hospitalisation (Nb séjours obstétrique/ Nb habitants) les plus élevés. Ces codes postaux sont classés de manière décroissante. Sont retenues dans la zone d\'attractivité de chirurgie les localités dont le cumul des séjours représente 80% de l\'activité de l\'établissement';
...
$locales['CHDActiviteZone-zone'] = 'Établissements de la zone d\'attractivité';
$locales['CHDActiviteZone-zone-court'] = 'Établissements de la zone d\'attractivité';
$locales['CHDActiviteZone-zone-desc'] = 'Établissements de la zone d\'attractivité';
...
$locales['CHDEtablissement'] = 'Établissement HospiDiag';
$locales['CHDEtablissement|pl'] = 'Établissements HospiDiag';
...
$locales['CHDEtablissement-msg-delete'] = 'Établissement HospiDiag supprimé';
$locales['CHDEtablissement-msg-found'] = 'Etablissement HospiDiag retrouvé';
$locales['CHDEtablissement-msg-modify'] = 'Établissement HospiDiag modifié';
...
$locales['CHDFinance-caf-desc'] = 'Cet indicateur permet d\'apprécier la capacité de l\'activité de l\'établissement à investir. Il mesure la « marge » que l\'établissement dégage sur son exploitation « courante », laquelle permet , au plan comptable de couvrir les charges d\'amortissements et de provisions et, au plan financier, de dégager de la trésorerie utilisée pour le remboursement des dettes existantes et pour financer tout ou partie des nouveaux investissements';
$locales['CHDFinance-caf_nette'] = 'Taux de CAF nette';
$locales['CHDFinance-caf_nette-court'] = 'CAF nette';
$locales['CHDFinance-caf_nette-desc'] = 'Cet indicateur mesure la capacité structurelle (hors effet éventuel du résultat de l\'exercice ainsi que des provisions par essence aléatoires et non pérennes) de l\'établissement à autofinancer le renouvellement de ses immobilisations. 
...
$locales['CHDFinance-dette_fournisseur-desc'] = 'Mesure la rotation de règlement aux fournisseurs en fin d\'année';
$locales['CHDFinance-duree_dette'] = 'Durée apparente de la dette';
$locales['CHDFinance-duree_dette-court'] = 'Durée dette';
$locales['CHDFinance-duree_dette-desc'] = 'Cet indicateur permet d\'apprécier la capacité d\'un établissement à rembourser sa dette. 
...
$locales['CHDFinance-fond_roulement_net-desc'] = 'Cet indicateur mesure la capacité de l\'établissement à financer son cycle d\'exploitation par des ressources stables';
$locales['CHDFinance-hd_etablissement_id'] = 'Établissement';
$locales['CHDFinance-hd_etablissement_id-court'] = 'Établissement';
$locales['CHDFinance-hd_etablissement_id-desc'] = 'Établissement de la finance';
...
$locales['CHDFinance-inde_finance'] = 'Ratio d\'indépendance financière';
$locales['CHDFinance-inde_finance-court'] = 'Indépendance financière';
$locales['CHDFinance-inde_finance-desc'] = 'Cet indicateur mesure le taux de dépendance financière de l\'établissement et donc les marges de manœuvre permettant d\'envisager de nouveaux emprunts';
...
$locales['CHDFinance-marge_brute-desc'] = 'Cet indicateur mesure la « marge » que l\'établissement dégage sur son exploitation « courante » pour financer ses charges financières, d\'amortissement et de provisions, c\'est-à-dire pour financer ses investissements';
...
$locales['CHDFinance-vetuste_bat'] = 'Taux de vétusté des bâtiments';
$locales['CHDFinance-vetuste_bat-court'] = 'Vétusté des bâtiments';
$locales['CHDFinance-vetuste_bat-desc'] = 'Cet indicateur mesure le besoin de rénovation/reconstruction des bâtiments';
...
$locales['CHDIdentite-caf-desc'] = 'La capacité d\'autofinancement (CAF) est le potentiel de l\'entreprise à dégager, de par son activité de la période, une ressource (un enrichissement de flux de fonds). 
...
$locales['CHDIdentite-coeff_transition-desc'] = 'Le passage à 100% devant comporter un « amortisseur », un coefficient de transition est appliqué de manière modulée à chaque établissement depuis 2008. 
Concrètement, l\'établissement devait disposer au 1er janvier 2008 du même montant de recettes que celui dont il aurait disposé dans le dispositif auparavant. Pour répondre à cette exigence, un mécanisme de coefficient de transition a été mis en place, permettant de prendre en compte l\'impact du passage à 100% T2A et assurant à l\'établissement le maintien de son niveau de recettes. 
...
$locales['CHDIdentite-encours_dette-desc'] = 'Compte 163 « Emprunts Obligataires » + Compte 164 « Emprunts auprès des établissements de crédit » + Comptes 165, 167, 168 « Emprunts
...
Le BFR est la différence entre l\'actif circulant (principalement stocks et créances) et le passif exigible (principalement dettes fournisseurs, dettes sociales et fiscales et avances reçues). 
= « Stocks et en cours » + « Créances d\'exploitation » + « Créances div erses » + « Charges constatées d\'avance » + « Comptes de régularisation (actif) sauf dotations attendues, prime de remboursement des obligations et charges à répartir sur plusieurs exercices» - « Avances reçues » - « Dettes fournisseurs et comptes rattachés » - « Dettes fiscales et sociales » - « Produits constatés d\'avance » - « Dettes sur immobilisations et comptes rattachés » - « dettes diverses autres » - « Comptes de régularisation (passif)». 
...
Cette information permet de repérer une « traditionnelle » d\'une chirurgie plus technique/spécialisée. 
Le classement est établi à partir de la dernière année disponible.
Les données sont repérées à partir de la classification V2016 des GHM';
...
Cette information permet de repérer une médecine « traditionnelle » d\'une médecine plus technique/spécialisée. 
Le classement est établi à partir de la dernière année disponible.
Les données sont repérées à partir de la classification V2016 des GHM';
...
Le classement est établi à partir de la dernière année disponible.
Les données sont repérées à partir de la classification V2016 des GHM';
$locales['CHDIdentite-hd_etablissement_id'] = 'Établissement';
$locales['CHDIdentite-hd_etablissement_id-court'] = 'Établissement';
$locales['CHDIdentite-hd_etablissement_id-desc'] = 'Établissement HospiDiag';
...
Le « nombre de séjours chirurgicaux avec acte classant », est l\'unité de mesure qui est celle des futurs décrets chirurgie';
...
$locales['CHDIdentite-nb_arthro_genou-desc'] = 'Cette information permet d\'apporter une indication sur le profil de l\'établissement : elle illustre le dynamisme des spécialités majeures, à travers le volume d\'activité représenté dans l\'établissement par les interventions les plus fréquentes, au niveau national. 
Ces interventions sont au nombre de six. Cinq font partie de la liste des « 18 gestes marqueurs de chirurgie ambulatoire ». L\'énumération des
codes CCAM conduisant à chacun de ces groupes est donnée en annexe 2. 
Pour la RTU prostate le code CCAM est « JGFA015 - résection d\'une hypertrophie de la prostate par urétrocystoscopie ».';
$locales['CHDIdentite-nb_atu'] = 'Nombre d\'ATU';
$locales['CHDIdentite-nb_atu-court'] = 'Nb ATU';
$locales['CHDIdentite-nb_atu-desc'] = 'Cette information permet d\'évaluer le nombre total de passages aux urgences ne donnant pas lieu à une hospitalisation, facturés ou non à l\'assurance maladie. 
Pour cerner l\'intégralité de l\'activité d\'urgences, il faut compléter cette donnée par le nombre de passages aux urgences donnant lieu à une hospitalisation (en UHCD ou en hospitalisation complète)';
...
- 28Z01Z - Entraînements à la dialyse péritonéale automatisée, en séances 
- 28Z02Z - Entraînements à la dialyse péritonéale continue ambulatoire, en séances 
- 28Z03Z - Entraînements à l\'hémodialyse, en séances 
...
$locales['CHDIdentite-nb_b'] = 'Nombre de B (B et GHN à partir de 2009)';
...
$locales['CHDIdentite-nb_cataracte-desc'] = 'Cette information permet d\'apporter une indication sur le profil de l\'établissement : elle illustre le dynamisme des spécialités majeures, à travers le volume d\'activité représenté dans l\'établissement par les interventions les plus fréquentes, au niveau national. 
Ces interventions sont au nombre de six. Cinq font partie de la liste des « 18 gestes marqueurs de chirurgie ambulatoire ». L\'énumération des
codes CCAM conduisant à chacun de ces groupes est donnée en annexe 2. 
Pour la RTU prostate le code CCAM est « JGFA015 - résection d\'une hypertrophie de la prostate par urétrocystoscopie ».';
...
$locales['CHDIdentite-nb_chir_sein-desc'] = 'Cette information permet d\'apporter une indication sur le profil de l\'établissement : elle illustre le dynamisme des spécialités majeures, à travers le volume d\'activité représenté dans l\'établissement par les interventions les plus fréquentes, au niveau national. 
Ces interventions sont au nombre de six. Cinq font partie de la liste des « 18 gestes marqueurs de chirurgie ambulatoire ». L\'énumération des
codes CCAM conduisant à chacun de ces groupes est donnée en annexe 2. 
Pour la RTU prostate le code CCAM est « JGFA015 - résection d\'une hypertrophie de la prostate par urétrocystoscopie ».';
...
$locales['CHDIdentite-nb_etp_non_med_educatifs_sociaux-desc'] = 'L\'information suivante est analysée : ETP non médicaux dont Personnels Éducatifs et Sociaux';
...
$locales['CHDIdentite-nb_hernie_adulte-desc'] = 'Cette information permet d\'apporter une indication sur le profil de l\'établissement : elle illustre le dynamisme des spécialités majeures, à travers le volume d\'activité représenté dans l\'établissement par les interventions les plus fréquentes, au niveau national. 
Ces interventions sont au nombre de six. Cinq font partie de la liste des « 18 gestes marqueurs de chirurgie ambulatoire ». L\'énumération des
codes CCAM conduisant à chacun de ces groupes est donnée en annexe 2. 
Pour la RTU prostate le code CCAM est « JGFA015 - résection d\'une hypertrophie de la prostate par urétrocystoscopie ».';
...
$locales['CHDIdentite-nb_lits_chir-desc'] = 'Ces informations donnent un aperçu des capacités d\'accueil de l\'établissement en chirurgie 
Les données concernant ces tableaux sont issues se l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
...
$locales['CHDIdentite-nb_lits_med-desc'] = 'Ces informations donnent un aperçu des capacités d\'accueil de l\'établissement en médecine. 
Les données concernant ces tableaux sont issues se l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
Les informations suivantes sont analysées : 
...
$locales['CHDIdentite-nb_lits_obs-desc'] = 'Ces informations donnent un aperçu des capacités d\'accueil de l\'établissement en obstétrique 
Les données concernant ces tableaux sont issues se l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
L\'information suivante est analysée :
...
$locales['CHDIdentite-nb_lits_reanimation-desc'] = 'Les données concernant ces tableaux sont issues de l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
...
$locales['CHDIdentite-nb_lits_soins_intensifs-desc'] = 'Les données concernant ces tableaux sont issues de l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
...
$locales['CHDIdentite-nb_lits_surv_continue-desc'] = 'Les données concernant ces tableaux sont issues de l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
...
$locales['CHDIdentite-nb_places_chir-desc'] = 'Ces informations donnent un aperçu des capacités d\'accueil de l\'établissement en chirurgie 
Les données concernant ces tableaux sont issues se l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
L\'information suivante est analysée :
...
$locales['CHDIdentite-nb_places_med-desc'] = 'Ces informations donnent un aperçu des capacités d\'accueil de l\'établissement en médecine. 
Les données concernant ces tableaux sont issues se l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
L\'information suivante est analysée :
...
$locales['CHDIdentite-nb_places_obs-desc'] = 'Ces informations donnent un aperçu des capacités d\'accueil de l\'établissement en obstétrique 
Les données concernant ces tableaux sont issues se l\'enquête SAE. Les données sont consultables sur le site SAE diffusion : 
http://www.sae-diffusion.sante.gouv .fr 
L\'information suivante est analysée :
...
Le nombre minimum de racines de GHM est obtenu après tri du casemix par effectifs décroissants';
...
- 28Z19Z - Préparations à une irradiation externe par RCMI ou techniques spéciales 
- 28Z20Z - Préparations à une irradiation externe av c dosimétrie tridimensionnelle avec HDV 
- 28Z21Z - Préparations à une irradiation externe avec dosimétrie tridimensionnelle sans HDV 
- 28Z22Z - Autres préparations à une irradiation externe 
...
$locales['CHDIdentite-nb_rsa_chir-desc'] = 'Ces informations permettent d\'évaluer le volume d\'activité pris en charge par l\'établissement en hospitalisation complète en chirurgie (ASO=C) 
Nombre de RSA de durée est égale ou supérieure à 1 jour (date de sortie différente de la date d\'entrée)';
...
$locales['CHDIdentite-nb_rsa_med-desc'] = 'Ces informations permettent d\'évaluer le volume d\'activité pris en charge par l\'établissement en hospitalisation complète en médecine (ASO=M) 
Nombre de RSA de durée est égale ou supérieure à 1 jour (date de sortie différente de la date d\'entrée)';
...
$locales['CHDIdentite-nb_rsa_obs-desc'] = 'Ces informations permettent d\'évaluer le volume d\'activité pris en charge par l\'établissement en hospitalisation complète en obstétrique(ASO=O) 
Nombre de RSA de durée est égale ou supérieure à 1 jour (date de sortie différente de la date d\'entrée)';
...
$locales['CHDIdentite-nb_rtu_prostate-desc'] = 'Cette information permet d\'apporter une indication sur le profil de l\'établissement : elle illustre le dynamisme des spécialités majeures, à travers le volume d\'activité représenté dans l\'établissement par les interventions les plus fréquentes, au niveau national. 
Ces interventions sont au nombre de six. Cinq font partie de la liste des « 18 gestes marqueurs de chirurgie ambulatoire ». L\'énumération des
codes CCAM conduisant à chacun de ces groupes est donnée en annexe 2. 
Pour la RTU prostate le code CCAM est « JGFA015 - résection d\'une hypertrophie de la prostate par urétrocystoscopie ».';
...
$locales['CHDIdentite-niveau_mater-desc'] = 'Cette information permet d\'apporter une indication sur le profil de la maternité de l\'établissement : maternité « traditionnelle » ou de recours';
$locales['CHDIdentite-prod_ac'] = 'Total des produits courants de fonctionnement dont AC (Aide à la contractualisation)';
$locales['CHDIdentite-prod_ac-court'] = 'AC';
$locales['CHDIdentite-prod_ac-desc'] = 'Total des recettes d\'exploitation (Compte 70 à 75 hors 7087) dont AC (Aide à la Contractualisation)';
...
$locales['CHDIdentite-prod_merri-desc'] = 'Total des recettes d\'exploitation (Compte 70 à 75 hors 7087) dont MERRI (les missions « PHRC » [MIG_06] et « laboratoires d\'oncogénétique, de génétique moléculaire, de cytogénétique et de neurogénétique » [MIG_28] ne sont pas prises en compte)';
...
$locales['CHDIdentite-prod_migac-desc'] = 'Total des recettes d\'exploitation (Compte 70 à 75 hors 7087) dont recettes MIGAC';
...
$locales['CHDIdentite-prod_recette_daf-desc'] = 'Total des recettes d\'exploitation (Compte 70 à 75 hors 7087) dont Recettes DAF';
...
$locales['CHDIdentite-prod_taa-desc'] = 'Total des recettes d\'exploitation (Compte 70 à 75 hors 7087) dont recettes T2A';
$locales['CHDIdentite-resultat_consolide'] = 'Résultat consolidé';
$locales['CHDIdentite-resultat_consolide-court'] = 'Résultat consolidé';
$locales['CHDIdentite-resultat_consolide-desc'] = 'Cette information est le reflet de la performance financière globale de l\'établissement et de son équilibre budgétaire. Le résultat est analysé à la fois en consolidé (prise en compte des budgets annexes) et sur le budget principal (hôpital) 
Les informations suivantes sont analysées : 
- Résultat consolidé
...
$locales['CHDIdentite-resultat_net-desc'] = 'Cette information est le reflet de la performance financière globale de l\'établissement et de son équilibre budgétaire. 
Les informations suivantes sont analysées :
...
$locales['CHDIdentite-taux_info_agenda_patient-desc'] = 'Cette donnée mesure le niveau d\'informatisation de l\'établissement de santé sur le domaine fonctionnel « Programmation des ressources et agenda du patient »';
...
$locales['CHDIdentite-taux_info_dpii-desc'] = 'Cette donnée mesure le niveau d\'informatisation de l\'établissement de santé sur le domaine fonctionnel « DPII (Dossier patient informatisé et interopérable) et communication extérieure »';
...
$locales['CHDIdentite-taux_info_ima_bio_ana-desc'] = 'Cette donnée mesure le niveau d\'informatisation de l\'établissement de santé sur le domaine fonctionnel «Résultats d\'imagerie, de biologie et d\'anatomo-pathologie».';
...
$locales['CHDIdentite-taux_info_med-desc'] = 'Cette donnée mesure le niveau d\'informatisation de l\'établissement de santé sur le domaine fonctionnel « Pilotage médico-économique »';
...
$locales['CHDIdentite-taux_info_presc-desc'] = 'Cette donnée mesure le niveau d\'informatisation de l\'établissement de santé sur le domaine fonctionnel « Prescription électronique alimentant le plan de soins »';
...
$locales['CHDIdentite-total_charges-desc'] = 'Cette information met en évidence la taille de l\'établissement (avec un focus sur les charges liées à l\'activité MCO). 
Les informations suivantes sont analysées : 
- Total des charges de fonctionnement (comptes 60 à 65 hors 7087)
    - Dont dépenses MCO';
...
$locales['CHDIdentite-total_charges_mco-desc'] = 'Total des charges de fonctionnement (comptes 60 à 65 hors 7087) dont dépenses MCO 
...
Les informations suivantes sont analysées : 
Total des recettes d\'exploitation (Compte 70 à 75 + 7722 hors 7087) dont: 
- Recettes T2A 
- Recettes MIGAC 
    - dont MERRI (les missions « PHRC » [MIG_06] et « laboratoires d\'oncogénétique, de génétique moléculaire, de cytogénétique et de neurogénétique » [MIG_28] ne sont pas prises en compte) 
    - dont AC 
- Recettes DAF';
...
$locales['CHDProcess-hd_etablissement_id'] = 'Établissement';
$locales['CHDProcess-hd_etablissement_id-court'] = 'Établissement';
$locales['CHDProcess-hd_etablissement_id-desc'] = 'Établissement du process';
...
$locales['CHDProcess-indice_facturation-desc'] = 'L\'indicateur cherche à mesurer l\'efficacité de la chaine de facturation de l\'établissement, en mettant en évidence le manque à gagner lié à une facturation tardive des séjours à l\'Assurance Maladie';
$locales['CHDProcess-ip_dms_chir'] = 'IP - DMS Chirurgie (hors ambulatoire)';
$locales['CHDProcess-ip_dms_chir-court'] = 'DMS chirurgie';
$locales['CHDProcess-ip_dms_chir-desc'] = 'Cet indicateur compare la DMS de chirurgie de l\'établissement à celle standardisée de son casemix auquel on applique les DMS de référence
...
$locales['CHDProcess-ip_dms_med-desc'] = 'Cet indicateur compare la DMS de médecine de l\'établissement à celle standardisée de son casemix auquel on applique les DMS de référence de chaque GHM de médecine. 
...
$locales['CHDProcess-ip_dms_obs-desc'] = 'Cet indicateur compare la DMS de l\'obstétrique de l\'établissement à celle standardisée de son case mix auquel on applique les DMS de
...
$locales['CHDProcess-nb_examens_bio_par_technicien-desc'] = 'Cet indicateur évalue la productivité du personnel des laboratoires, à travers l\'activité de biologie';
...
$locales['CHDProcess-nb_icr_par_salle-desc'] = 'Cet indicateur reflète l\'utilisation et donc, indirectement l\'organisation au niveau des blocs opératoires : il permet de mettre en évidence une sous ou sur utilisation des salles de blocs disponibles';
$locales['CHDProcess-niveau_prerequis_hopital_numerique'] = 'Niveau d\'atteinte des prérequis Hôpital Numérique';
$locales['CHDProcess-niveau_prerequis_hopital_numerique-court'] = 'Niveau prérequis Hôpital Numérique';
$locales['CHDProcess-niveau_prerequis_hopital_numerique-desc'] = 'Cet indicateur évalue la solidité des bases du système d\'information de l\'établissement de santé';
...
$locales['CHDProcess-pct_depenses_admin_logistique_technique-desc'] = 'Ce ratio global mesure le pourcentage des dépenses consacrées aux « frais généraux » de l\'établissement, compte tenu de ce qui est sous
traité ou produit pour le compte d\'autres structures. 
Il donne une première mesure du poids des fonctions support de l\'établissement';
$locales['CHDProcess-poids_cout_personnel_med'] = 'Coût du personnel médical des services cliniques rapporté aux recettes';
$locales['CHDProcess-poids_cout_personnel_med-court'] = 'Coût personnel médical/recettes';
$locales['CHDProcess-poids_cout_personnel_med-desc'] = 'Cet indicateur permet de mesurer le poids des coûts de personnel médical dans les recettes et ainsi la performance de l\'organisation
médicale';
$locales['CHDProcess-poids_cout_personnel_non_med'] = 'Coût du personnel non médical des services cliniques rapporté aux recettes';
$locales['CHDProcess-poids_cout_personnel_non_med-court'] = 'Coût personnel non médical/recettes';
$locales['CHDProcess-poids_cout_personnel_non_med-desc'] = 'Cet indicateur permet de mesurer le poids des coûts de personnel soignant dans les recettes et ainsi la performance de l\'organisation
soignante';
$locales['CHDProcess-poids_cout_personnel_services_medico_technique'] = 'Coût du personnel relatif aux services médico-techniques rapporté aux recettes';
$locales['CHDProcess-poids_cout_personnel_services_medico_technique-court'] = 'Coût personnel services médico-techniques/recettes';
$locales['CHDProcess-poids_cout_personnel_services_medico_technique-desc'] = 'Cet indicateur permet de mesurer le poids des coûts de personnel médico-technique dans les recettes et ainsi la performance de l\'organisation médico-technique.
...
$locales['CHDProcess-taux_gestes_marqueurs_chir_ambu-desc'] = 'Cet indicateur mesure le dynamisme de l\'évolution des pratiques professionnelles chirurgicales v ers l\'ambulatoire, au travers de l\'analyse des 18 gestes marqueurs (1° niveau de substitution)';
...
$locales['CHDProcess-taux_utilisation_places_chir_ambu-desc'] = 'Cet indicateur reflète l\'organisation au niveau de la chirurgie l\'ambulatoire : il permet de mettre en évidence une sur ou sous capacité d\'accueil des patients en chirurgie ambulatoire (hors endoscopies)';
...
$locales['CHDQualite-conformite_dossier_anesth-desc'] = 'Cet indicateur évalue la tenue du dossier anesthésique, sur la base de 13 critères';
...
$locales['CHDQualite-conformite_dossier_patient-desc'] = 'Cet indicateur évalue la tenue et le contenu du dossier des patients hospitalisés, sur la base de 10 critères au maximum';
...
$locales['CHDQualite-depistage_nutri-desc'] = 'Cet indicateur évalue le dépistage des troubles nutritionnels du patient adulte à l\'admission en médecine et en chirurgie';
$locales['CHDQualite-hd_etablissement_id'] = 'Établissement';
$locales['CHDQualite-hd_etablissement_id-court'] = 'Établissement';
$locales['CHDQualite-hd_etablissement_id-desc'] = 'Établissement HospiDiag';
...
$locales['CHDQualite-niveau_certif-desc'] = 'Cet indicateur renseigne sur le niveau de certification de l\'établissement à l\'issue de la procédure de certification des établissements de santé mise en œuvre par la Haute Autorité de Santé';
...
$locales['CHDQualite-score_naso-desc'] = 'Cet indicateur mesure les moyens mis en œuvre pour lutter contre les infections nosocomiales dans les établissements, à travers quatre indicateurs ; 
...
$locales['CHDQualite-tracabilite_eval_douleur'] = 'Traçabilité de l\'évaluation de la douleur';
$locales['CHDQualite-tracabilite_eval_douleur-court'] = 'Traçabilité éval douleur';
...
$locales['CHDResshum-hd_etablissement_id'] = 'Établissement';
$locales['CHDResshum-hd_etablissement_id-court'] = 'Établissement';
$locales['CHDResshum-hd_etablissement_id-desc'] = 'Établissement HospiDiag';
...
$locales['CHDResshum-interim_med-desc'] = 'Cet indicateur permet de mesurer la difficulté de l\'établissement à pourvoir les postes de personnel médical.';
...
$locales['CHDResshum-nb_iade_par_anesth-desc'] = 'Cet indicateur reflète la structure des équipes d\'anesthésie dans les établissements publics et ESPIC';
...
$locales['CHDResshum-nb_sage_femme_par_obs-desc'] = 'Cet indicateur reflète la structure des équipes d\'obstétrique dans les établissements publics et espic';
...
$locales['CImportConflict-conflict-choice'] = 'Action à effectuer';
...
$locales['mod-openData-import-commune-france'] = 'Communes françaises';
...
$locales['mod-openData-import-hd-annee'] = 'Année à importer';
$locales['mod-openData-import-line-%d-error-%s'] = 'Ligne %d : %s';
$locales['mod-openData-import-options'] = 'Options d\'import';
$locales['mod-openData-import-update'] = 'Mettre à jour les données';
$locales['mod-openData-start-at'] = 'Commencer à';
...
$locales['mod-openData-tab-configure'] = 'Administrer';
...
$locales['mod-openData-version'] = 'Version du fichier à importer';
...
$locales['mod-openData-zip'] = 'Utiliser le zip plutôt que de télécharger le fichier';
$locales['module-openData-court'] = 'Données libres';
$locales['module-openData-long'] = 'Données libres';
$locales['module-openData-trigramme'] = 'OD';
...
$locales['openData-msg-Hd etab create'] = 'Établissement HospiDiag créé';
