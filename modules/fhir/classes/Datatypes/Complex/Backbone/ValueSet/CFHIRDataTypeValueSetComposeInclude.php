 ...
 * FHIR data type
 */
class CFHIRDataTypeValueSetComposeInclude extends CFHIRDataTypeBackboneElement
{
    /** @var string */
    public const NAME = 'ValueSet.compose.include';

    public ?CFHIRDataTypeUri $system = null;

    public ?CFHIRDataTypeString $version = null;

    /** @var CFHIRDataTypeValueSetInConcept[]|null  */
    public ?array $concept = null;

    /** @var CFHIRDataTypeValueSetComposeInFilter[]|null  */
