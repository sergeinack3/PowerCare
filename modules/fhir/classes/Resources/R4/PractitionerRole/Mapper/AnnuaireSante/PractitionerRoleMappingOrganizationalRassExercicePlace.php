...
class PractitionerRoleMappingOrganizationalRassExercicePlace implements DelegatedObjectMapperInterface, PractitionerRoleMappingInterface
{
    ...
    public function mapOrganization(): ?CFHIRDataTypeReference
    {
        ...
        $medecin = $this->object->loadUniqueBackRef('medecin');

        $organizations = $medecin->getExercicePlaces();
