...
<form name="editTabEntryHL7Code" action="?m=hl7" method="post" onsubmit="return onSubmitFormAjax(this, {
    onComplete : Tables_hl7v2.refreshModalTableHL7Submit.curry('{{$table_entry->number}}') });">
  <input type="hidden" name="m" value="hl7" />
  ...
  <table class="tbl">
    <tr>
      ...
      <td class="disabled text">
        {{mb_field object=$table_entry field="description" size="25"}}
      </td>
    </tr>
  </table>
</form>