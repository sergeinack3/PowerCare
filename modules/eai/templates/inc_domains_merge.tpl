...
<form name="form-merge" method="post" onsubmit="return onSubmitFormAjax(this, function() { Control.Modal.close(); Domain.refreshListDomains(); });">
  ...
  <table class="form merger">
    <tr>
      ...
      <th class="category">{{$domain1}}</th>
      <th class="category">{{$domain2}}</th>
    </tr>
    ...
    <tr>
      ...
      <td>
        <label>
          <input type="radio" name="tag" value="{{$domain1->tag}}" checked />
          {{$domain1->tag}}
        </label>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <label>
          <input type="radio" name="incrementer_id" value="{{$domain1->incrementer_id}}" checked
    ...
    <tr>
      ...
      <td>
        <label>
          <input type="radio" name="actor_id" value="{{$domain1->actor_id}}" checked
    ...
    <tr>
      ...
      <td>
        <label>
          <input type="radio" name="libelle" value="{{$domain1->libelle}}" checked />
          {{$domain1->libelle}}
        </label>
      </td>
      <td>
    ...
    <tr>
      <td colspan="100" class="button">
        <button class="merge" onclick="return Domain.confirm();">
          {{tr}}Merge{{/tr}}
        </button>
      </td>
    </tr>
