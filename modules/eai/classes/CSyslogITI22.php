...
/**
 * ITI-22 Patient Demographics Consumer audit message
 *
 ...
 */
class CSyslogITI22 extends CSyslogAuditMessage {
  ...
  public function setEventTypeCode() {
    ...
    $this->setEVAttributes(
      $event_identification_event_type_code, 'ITI-22', 'Patient Demographics and Visit Query', 'IHE Transactions'
    );
  ...
  public function setQueryParametersParticipantObjectIDTypeCode() {
    ...
    $this->setEVAttributes($participant_object_id_type_code, 'ITI-22', 'Patient Demographics and Visit Query', 'IHE Transactions');
  ...
  public function setQueryParametersParticipantObjectQuery() {
    ...
    $participant_object_query = $this->msg_xml->addElement(
      $this->query_parameters, 'ParticipantObjectQuery', base64_encode($qpd->data)
    );
