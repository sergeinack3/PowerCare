 ...
 * Description
 */
class SejourRepositoryException extends CMbException
{
    /** @var int */
    public const MULTIPLE_SEJOUR_FOUND = 1;
    /** @var int */
    public const PATIENT_DIVERGENCE_FOUND = 2;
    ...
    {
        parent::__construct("SejourRepositoryException-$id", ...$args);
