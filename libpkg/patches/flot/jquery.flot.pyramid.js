...
var FlotPyramid = (function(){
  ...
  function processOptions(plot, options) {
    ...
    if (options.series.pyramid && options.series.pyramid.show) {
      ...
      jQuery.extend(options.series.bars, {
        show: true,
        horizontal: true,
        align: 'center',
  ...
  function processRawData(plot, series, datapoints) {
    ...
    series.data = jQuery.extend(true, [], series.data);
  ...
  function allTicksPresent(data, yaxisTicks) {
    ...
    expected_labels = jQuery.map(yaxisTicks, function(e) { return e[1] });
    labels = jQuery.map(data, function(e) { return e[0] });
