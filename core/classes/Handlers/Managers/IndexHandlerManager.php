 ...
 * Description
 */
class IndexHandlerManager extends AbstractHandlerManager
{
    /** @var static[] */
    ...
    {
        $handlers = CAppUI::gconf('system index_handlers', $this->group_id);
    ...
    {
        return (bool)CAppUI::gconf("system index_handlers {$class}", $this->group_id);
    }
