 ...
 * Description
 */
class EAIHandlerManager extends AbstractHandlerManager
{
    /** @var static[] */
    ...
    {
        $handlers = CAppUI::gconf('system eai_handlers', $this->group_id);
    ...
    {
        return (bool)CAppUI::gconf("system eai_handlers {$class}", $this->group_id);
    }
