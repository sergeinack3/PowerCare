...
/**
 * "Min length" specification
 */
class MinLength extends ValueBound implements SpecificationInterface, ParameterizedSpecificationInterface {
  use PropertyTrait;
  ...
  protected function getViolationMessage($candidate): string {
    return sprintf(
      "Object.%s length must be shorter or equal to: '%s' (Candidate: '%s').",
