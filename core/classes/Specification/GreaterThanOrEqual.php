...
/**
 * "Greater than or equals" specification
 */
class GreaterThanOrEqual extends ValueBound implements SpecificationInterface, ParameterizedSpecificationInterface {
  use PropertyTrait;
  ...
  protected function getViolationMessage($candidate): string {
    return sprintf(
      "Object.%s must be greater or equal to: '%s' (Candidate: '%s').",
